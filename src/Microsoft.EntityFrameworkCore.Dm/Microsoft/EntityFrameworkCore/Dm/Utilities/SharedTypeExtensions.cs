...
namespace Microsoft.EntityFrameworkCore.Dm.Utilities
{
	...
	internal static class SharedTypeExtensions
	{
		...
		public static bool IsPropertyBagType(this Type type)
		{
			...
			IEnumerable<Type> genericTypeImplementations = type.GetGenericTypeImplementations(typeof(IDictionary<, >));
			return genericTypeImplementations.Any((Type t) => t.GetGenericArguments()[0] == typeof(string) && t.GetGenericArguments()[1] == typeof(object));
		}
		...
		public static bool IsCompatibleWith(this Type propertyType, Type fieldType)
		{
			...
			return type != null && type2 != null && type.IsCompatibleWith(type2);
		}
		...
		public static IEnumerable<string> GetNamespaces([JetBrains.Annotations.NotNull] this Type type)
		{
			...
			{
				foreach (string @namespace in typeArgument.GetNamespaces())
				{
